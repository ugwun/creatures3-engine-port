...
void Configurator::Get(const std::string &name, std::string &value) const {
  std::map<std::string, std::string>::const_iterator it;
...
void Configurator::Get(const std::string &name, int &value) const {
  if (!Exists(name))
    return;
...
void Configurator::Set(const std::string &name, const std::string &value) {
  if (myFilename.empty())
    return;
...
void Configurator::Set(const std::string &name, const int value) {
  if (myFilename.empty())
    return;
...
bool Configurator::ParseLine(const std::string &src, std::string &name,
