...
{
	uint32 dwStyle = WS_POPUPWINDOW|WS_OVERLAPPED|WS_BORDER|WS_VISIBLE;	//WS_CHILD|WS_OVERLAPPED|WS_BORDER;
	uint32 dwExStyle = WS_EX_OVERLAPPEDWINDOW;
...
void CLabelThing::PopUp( const char* szLabel, POINT pt, bool bSticky, bool bFrameColour, COLORREF colFrame)
{
	m_strText = szLabel;
	m_ptPos = pt;
	m_bSticky = bSticky;
