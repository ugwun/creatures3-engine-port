...
#include "CreaturesArchive.h"
		...
		public: \
			...
			virtual const char* GetClassNameX() const;\
		private: \
		...
		const char* ClassType::GetClassNameX() const {return #ClassType;}\
...
class PersistentObject
	...
	public:
		...
		virtual const char* GetClassNameX() const {return "PersistantObject";}
		...
		// Description:	
		// ----------------------------------------------------------------------
		static PersistentObject *New(const char* name);
		...
		// ----------------------------------------------------------------------
		static int AddClass(const char* name, NewObjectFunction function);
	...
	private:
		...
		class DeclaredClassList
			...
			public:
				...
				// ----------------------------------------------------------------------
				PersistentObject *New(const char* name);
				...
				// ----------------------------------------------------------------------
				void Add(const char* name, NewObjectFunction function);
			...
			private:
				...
				class DeclaredClass
					...
					public:
						...
						// ----------------------------------------------------------------------
//						bool Match(const char* name) {return className.Compare(name)==0;}
						bool Match(const char* name) {return className.compare(name)==0;}
