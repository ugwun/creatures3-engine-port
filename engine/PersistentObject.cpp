...
// ----------------------------------------------------------------------
PersistentObject *PersistentObject::New(const char* name)
	{
...
// ----------------------------------------------------------------------
int PersistentObject::AddClass(const char* name, NewObjectFunction function)
...
//				with the CREATURES_DECLARE/IMPLEMENT_SERIAL macros
// ----------------------------------------------------------------------
PersistentObject *PersistentObject::DeclaredClassList::New(const char* name)
	{
...
// ----------------------------------------------------------------------
void PersistentObject::DeclaredClassList::Add(const char* name,
