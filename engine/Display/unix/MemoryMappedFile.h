...
// Removed ReadUINT32Ptr and ReadUINT16Ptr as they are unused and could return
// unaligned pointers.
...
inline uint16 MemoryMappedFile::ReadUINT16() {
  uint16 value;
  memcpy(&value, myBasePtr + myPosition, sizeof(uint16));
...
inline uint32 MemoryMappedFile::ReadUINT32() {
  uint32 value;
  memcpy(&value, myBasePtr + myPosition, sizeof(uint32));
