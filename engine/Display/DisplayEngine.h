...
//class has 				private constructors and a static member function which 				gives access
//to the one and only DisplayEngine to all clients
//
//
...
#ifdef C2E_SDL
// -------------------------------------------------------------------------
// *Probably* the modern cross-platform redirect for graphics.
// When compiling for SDL (which modern ports usually do),
// DisplayEngine is functionally replaced by SDL_DisplayEngine.
// -------------------------------------------------------------------------
// divert to alternate includefile
#include "SDL/SDL_DisplayEngine.h"
#else
// Legacy version of DisplayEngine takes up rest of file...
...
// C16 file flags.
const uint32 C16_FLAG_565 = 0x00000001;
const uint32 C16_16BITFLAG = 0x00000002;
