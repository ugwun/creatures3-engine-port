...
//				its own direct draw surfaces and can be drawn
//straight to 				the display engine when updated.
//
// Description:
//
//
...
public:
  FastEntityImage();
  FastEntityImage(EntityImage &entity, SDL_Surface *image,
                  SDL_Surface *background, int32 plane, bool fullScreen);
...
private:
  ...
  bool WorkOutClippedArea(RECT &clip, int32 &x, int32 &y);
