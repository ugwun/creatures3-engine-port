...
// CalculateGenerationNumber is defined in MonikerGeneration.cpp
// (shared between engine and unit tests).
...
GenomeStore::TryGenerateUniqueMoniker(const std::string &monikerSeed1,
  ...
  int ownGeneration =
      GenomeStore::CalculateGenerationNumber(monikerSeed1, monikerSeed2);
