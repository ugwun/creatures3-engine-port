...
class MusicScript
	...
	public:
		...
		// ----------------------------------------------------------------------
		const char* GetCurrentToken() const {return currentToken.data();}
		...
		// ----------------------------------------------------------------------
		int GetOffset() {return currentPos - (const char*) text.data();}
	...
	private:
		...
		bool IsCarriageReturn(const char* str)
		...
		//				ported
		// ----------------------------------------------------------------------
		const char* SkipCarriageReturn(const char* str) {return str+2;}
