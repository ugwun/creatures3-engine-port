...
class MusicLayer : public MusicUpdatable
	...
	public:
		...
		// ----------------------------------------------------------------------
		virtual MusicValue *GetVariable(const char* varName, bool lvalue = false);
		...
		// ----------------------------------------------------------------------
		static MusicWaveID GetWaveID(const char* name);
		...
		// ----------------------------------------------------------------------
		static MusicEffectID GetEffectID(const char* name);
		...
		//			etc.
		// ----------------------------------------------------------------------
		static void Munge(const char* name, const char* script);
	...
	protected:
		...
		// ----------------------------------------------------------------------
		uint32 ConvertName(const char* name);
