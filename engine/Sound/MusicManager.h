...
//Fade all wait 					until the next update before taking effect
...
public:
  ...
  // ----------------------------------------------------------------------
  const char* Load(const char* script);
  ...
  // Set the MNG filename directly (used at startup to apply the Default Munge
  // config)
  void SetCurrentMNG(const std::string &mng) { currentMNG = mng; }
  ...
  //				This will take effect at the next call to
  //Update()
  // ----------------------------------------------------------------------
  void Play() { statusEvent = PlayEvent; }
  ...
  //Update()
  // ----------------------------------------------------------------------
  void Pause() { statusEvent = PauseEvent; }
  ...
  // ----------------------------------------------------------------------
  bool SetVariable(const char* name, MusicValue value);
  ...
  //				manager
  // ----------------------------------------------------------------------
  bool ReadVariableContents(const char* name, MusicValue &value);
  ...
  // ----------------------------------------------------------------------
  MusicValue *GetVariable(const char* varName, bool lvalue = false);
  ...
  // Returns:		Nothing
  // Description:	Fades out current track quickly, and starts the new
  // track
  //				playing.
  //				This will take effect at the next call to
  //Update()
  // ----------------------------------------------------------------------
  void InteruptTrack(const char* name) {
    trackEvent = InteruptEvent;
    nextTrackName = name;
  }
  ...
  //Update()
  // ----------------------------------------------------------------------
  void Fade() { trackEvent = FadeEvent; }
  ...
  // Description:	Reads the next track from the list
  // ----------------------------------------------------------------------
  inline int NumberOfTracks() const { return tracks.size(); }
...
private:
  ...
  //				automatically restart from the beginning
  // ----------------------------------------------------------------------
  void ActivateBeginTrack(const char* name);
  ...
  //				playing.
  // ----------------------------------------------------------------------
  void ActivateInteruptTrack(const char* name);
  ...
  // ----------------------------------------------------------------------
  void Approach(MusicValue &currentValue, MusicValue desiredValue,
