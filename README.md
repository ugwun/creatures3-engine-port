...
#### 📺 Programming with AI — Developing the Creatures 3 Engine *(YouTube)*

[![YouTube](https://img.shields.io/badge/Watch%20on-YouTube-red?logo=youtube&logoColor=white)](https://www.youtube.com/watch?v=2vaKrkKwIHY)

<a href="https://www.youtube.com/watch?v=2vaKrkKwIHY"><img src="programming_with_ai_thumbnail.jpg" alt="Programming with AI — Developing the Creatures 3 Engine" width="480"></a>

See how modern AI tools like Google's Antigravity IDE and MCP can accelerate game development. In this video, Cyril Sadovsky demonstrates using AI agents to explore the 30-year-old *Creatures 3* C++ codebase, debug the engine in real-time using the custom developer tools, and automatically generate wiki documentation. It shows how anyone can start contributing to deep tech projects using AI pair programming.

#### 📺 AI reads AI — LLM Integration via MCP *(YouTube)*

[![YouTube](https://img.shields.io/badge/Watch%20on-YouTube-red?logo=youtube&logoColor=white)](https://www.youtube.com/watch?v=vz_2FZQ_2V8)

<a href="https://www.youtube.com/watch?v=vz_2FZQ_2V8"><img src="creatures_mcp_thumbnail.jpg" alt="AI reads AI — Creatures 3 × MCP" width="320"></a>
...
#### 📺 AI Learning in Real Time — Creatures 3 & the Embodiment Crisis *(YouTube)*
...
| **Tier 2** | Tick control, game variables, scriptorium, save/reload | Same as Tier 1 |
| **Tier 3** | Docked world, agents, map, COS scripts | Dynamically copies `Startup` template inside **original** game dir |
| **Tier 4** | Creature lifecycle, biochemistry, neural networks | Same as Tier 3 |
| **Tier 5** | Long-running stability and stress testing | Same as Tier 3 |
