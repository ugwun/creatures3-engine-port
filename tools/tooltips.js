...
const TIPS = [
    ...
    { selector: '#btn-genetics-new', text: 'Create a brand new blank genome in-memory' },
    { selector: '#btn-genetics-import', text: 'Load a genome from a JSON file into the editor' },
    { selector: '#btn-genetics-export', text: 'Export the current genome structure back down to a JSON file on your machine' },
    { selector: '#btn-genetics-save', text: 'Save the currently modified genome back to the engine\'s genetics folder as a .gen file' },
